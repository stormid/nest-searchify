...
{
    public class SampleSportingTeamSearchQuery : SearchParametersQuery<SearchParameters, SportingTeamDocument, SearchResult<SearchParameters, SportingTeamDocument>>
    {
        public SampleSportingTeamSearchQuery(SearchParameters parameters) : base(parameters, "$type", () => DocTypeValueFuncDefault)
        {
        }
    }
    ...
    public class SampleSearchQuery : SearchParametersQuery<PersonSearchParameters, PersonDocument, PersonSearchResult>
    {
        ...
        public SampleSearchQuery(PersonSearchParameters parameters) : base(parameters, "$type", () => DocTypeValueFuncDefault)
        {
        }
