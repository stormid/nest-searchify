...
namespace Nest.Searchify
{
    ...
    //{
    //    public static IParameterisedAggregate<TParameters> FilterFor<TParameters, TDocument>(
    ...
    //        IDictionary<string, Func<ISearchResult<TParameters, TDocument>, Expression<Func<TParameters, object>>, string, IParameterisedAggregate<TParameters>>> additionalFilterProviders = null)
    ...
    //                , string, IParameterisedAggregate<TParameters>>>(additionalFilterProviders ?? new Dictionary<string, Func<ISearchResult<TParameters, TDocument>, Expression<Func<TParameters, object>>, string, AggregationFilterModel<TParameters>>>())
    //            {
    //                {"term", TermFilterFor },
